...
Отвечай на русском языке, используй эмодзи для лучшего восприятия, но не злоупотребляй ими. Будь точным, информативным и поддерживающим.✨`
    ...
    const relevantTopics = [
        ...
        // ДОБАВЬТЕ ЭТИ СЛОВА для темы ИГНОРА:
        'игнор', 'молчан', 'избеган', 'неотвеч', 'тишина', 
        'холодн', 'дистанц', 'отдален', 'уход', 'разрыв',
        'обид', 'ссор', 'конфликт', 'непониман',
        
        // ДОБАВЬТЕ ЭТИ СЛОВА для темы ВЛЮБЛЕННОСТИ:
        'влюблен', 'романт', 'чувств', 'сердц', 'симпати',
        'нераздел', 'привязан', 'влечен', 'любов', 'эмоц'
    ];
    ...
    if (messageLower.includes('влюблен') || messageLower.includes('романт') || messageLower.includes('чувств') && !messageLower.includes('манипуляц')) {
