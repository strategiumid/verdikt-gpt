...
COPY index.html app.js main.js particles.js apiClient.js chatStore.js uiManager.js encryptionService.js authService.js styles.css themes.css crypto.js service-worker.js manifest.json instructions.txt ./backend/src/main/resources/static/
